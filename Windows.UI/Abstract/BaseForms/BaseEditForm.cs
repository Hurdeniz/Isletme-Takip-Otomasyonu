...
using Windows.UI.Concrete.UseControls.Grid;
    ...
    public partial class BaseEditForm : RibbonForm
    {
        ...
        protected void Eventsload()
        {
            ...
            void ControlEvents(Control control)
            {
                ...
                control.GotFocus += Control_GotFocus;//controle focuslanma
                control.Leave += Control_Leave;// controlden ayrılma durumu
                ...
                switch (control)
                {
                    ...
                    case MyButtonEdit edt:
                        ...
                        edt.EnableChange += Control_EnableChange;
        ...
        private Boolean Kaydet(bool kapanis)
        {
            bool KayitIslemi()
            {
        ...
        protected virtual void Goruntule() { }
        ...
        protected internal virtual IBaseEntity ReturnValue() { return null; }
        ...
        private void Control_GotFocus(object sender, EventArgs e)
        {
            ...
            if (type == typeof(MyButtonEdit) || type == typeof(MyGridView) || type == typeof(MyDateEdit) || type == typeof(MyComboBoxEdit) || type == typeof(MyCalcEdit))
            {
                statusBarKisayol.Visibility = BarItemVisibility.Always;
                statusBarKisayolAciklama.Visibility = BarItemVisibility.Always; // buton içeren yada herhangi biri ise gösterme

                statusBarAciklama.Caption = ((ISatusBarAciklama)sender).StatusBarAciklama;
            ...
            else if (sender is ISatusBarAciklama ctrl)
